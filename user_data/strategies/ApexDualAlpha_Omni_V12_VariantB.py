"""
ApexDualAlpha_Omni_V12_VariantB - Short-Only LINK Alpha & Natural Hedge
Curated for Bybit Linear Futures 8-Pair Universe: BTC, ETH, SOL, ADA, DOGE, LINK, PAXG, HYPE.

LINK Specific Tuning:
- Long LINK: Completely Disabled (LINK is dedicated Short-Only alpha & natural hedge).
...
class ApexDualAlpha_Omni_V12_VariantB(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # LINK Specialization (Varian B: Short-Only LINK, Longs Completely Disabled)
        if "LINK" in pair:
        ...
        # Long Entry: LINK is strictly excluded
        if "LINK" not in pair:
