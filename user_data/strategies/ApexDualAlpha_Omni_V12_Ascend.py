"""
ApexDualAlpha_Omni_V12_Ascend - Adaptive Trend-Onset Calibration
...
class ApexDualAlpha_Omni_V12_Ascend(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def informative_4h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["slope_50"] = dataframe["ema_50"] - dataframe["ema_50"].shift(3)
        dataframe["macro_bull_4h"] = (dataframe["close"] > dataframe["ema_50"]) & (
            (dataframe["ema_50"] > dataframe["ema_200"]) | (dataframe["close"] > dataframe["ema_200"]) | (dataframe["slope_50"] > 0)
        )
