"""
ApexDualAlpha_Futures_Strategy - Institutional High-Winrate Bidirectional Alpha Engine
Key Innovations:
...
class ApexDualAlpha_Futures_Strategy(IStrategy):
    ...
    def leverage(self, pair: str, current_time: datetime, current_rate: float,
        ...
        """
        Dynamic Capital-Adaptive Leverage:
        - For BTC/USDT (min notional ~ $77 USDT): automatically scales to 7.0x leverage 
          so micro-accounts ($25 USDT) can execute orders seamlessly without rejection.
        - For all other prime altcoins (ETH, SOL, AVAX, DOGE, LINK, ADA, BNB, NEAR):
          maintains ultra-safe 3.0x leverage.
        """
        if "BTC" in pair:
            return 7.0
        return 3.0
