"""
ApexDualAlpha_Omni_V11_Calibrated - High-Yield Precision Quantitative Futures Strategy
Curated for Bybit Linear Futures 7-Pair Universe: BTC, ETH, SOL, ADA, DOGE, LINK, PAXG.
Calibrated: Weekend Adaptive Volume (0.40) + 2-Candle Stochastic Window + Preserved Macro Shield.
"""
...
class ApexDualAlpha_Omni_V11_Calibrated(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # 2-candle stochastic crossover window
        k_cross_up = (
        ...
        # Adaptive weekend volume filter
        ...
        if "BTC" not in pair:
            ...
            vol_factor_short = np.where(is_weekend, 0.42, 0.72)
